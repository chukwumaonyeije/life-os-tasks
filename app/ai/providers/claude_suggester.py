...
from app.ai.prompts import get_prompt, CURRENT_PROMPT_VERSION
...
class ClaudeSuggester:
    ...
    def suggest(self, text: str) -> Optional[AISuggestion]:
        ...
        try:
            ...
            logger.info(f"Claude suggestion: {suggestion.title} (confidence: {suggestion.confidence})")
            return suggestion
